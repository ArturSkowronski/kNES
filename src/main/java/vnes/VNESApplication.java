...
import vnes.applet.AppletLauncher;
import vnes.compose.ComposeMain;
...
public class VNESApplication {
    ...
    public static void main(String[] args) {
        ...
        // Create the Applet UI button
        JButton appletButton = new JButton("Launch Applet UI");
