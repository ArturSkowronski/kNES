...
class ComposeInputHandler(private val nes: NES) : DestroyableInputHandler {
    ...
    init {
        ...
        mapKey(InputHandler.KEY_A, KeyEvent.VK_Z)
        mapKey(InputHandler.KEY_B, KeyEvent.VK_X)
        mapKey(InputHandler.KEY_START, KeyEvent.VK_ENTER)
        mapKey(InputHandler.KEY_SELECT, KeyEvent.VK_SPACE)
        mapKey(InputHandler.KEY_UP, KeyEvent.VK_UP)
        mapKey(InputHandler.KEY_DOWN, KeyEvent.VK_DOWN)
        mapKey(InputHandler.KEY_LEFT, KeyEvent.VK_LEFT)
        mapKey(InputHandler.KEY_RIGHT, KeyEvent.VK_RIGHT)
    }
