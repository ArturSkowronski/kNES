...
class PPU : PPUCycles {
    ...
    fun setMirroring(mirroring: Int) {
        ...
        if (mirroring == knes.emulator.ROM.Companion.HORIZONTAL_MIRRORING) {
        ...
        } else if (mirroring == knes.emulator.ROM.Companion.SINGLESCREEN_MIRRORING) {
        ...
        } else if (mirroring == knes.emulator.ROM.Companion.SINGLESCREEN_MIRRORING2) {
            ntable1[0] = 1
            ntable1[1] = 1
            ntable1[2] = 1
            ntable1[3] = 1
    ...
    fun stateLoad(buf: knes.emulator.ByteBuffer) {
        // Check version:
