...
import knes.agent.agents.AdvisorAgent
...
import knes.agent.runtime.Watchdog
import knes.agent.runtime.ExecutorTrace
import knes.agent.runtime.Log
import knes.agent.runtime.Resumer
import knes.agent.runtime.TurnLog
import knes.agent.runtime.WatchdogTrace
import knes.agent.tools.DefaultToolSurface
...
private fun advanceMilestones(
    memory: knes.agent.runtime.Memory,
    phase: knes.agent.runtime.Phase,
    ram: Map<String, Int>,
