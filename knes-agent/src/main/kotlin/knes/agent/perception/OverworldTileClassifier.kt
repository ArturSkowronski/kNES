...
object OverworldTileClassifier {
    ...
    fun classify(tileId: Int): TileType = when (tileId and 0xFF) {
        ...
        0x56, 0x57, 0x58, 0x59,
        // V2.6.1: castle border / decoration tiles verified around Coneria
        // (ROM dump y=158-159, x=148-153). Hard-impassable so the pathfinder
        // routes around the castle perimeter rather than into it.
        0x2C, 0x2E, 0x3B, 0x3C, 0x3E, 0x3F,
        ...
        // V2.6.1: town center tile variants verified at Coneria (0x3D row).
        0x3D,
        0x5A, 0x5D, 0x6D ->
            TileType.TOWN
